...
function TermsOfService() {
  return (
    <>
      ...
      <body>
        <div className="text">
          <h1 id="header-title">Terms and Conditions</h1>
          ...
          <div className="TOC">
            <a href="#interpretation">Interpretation and Definitions</a>
            <br></br>
            ...
            <br></br>
            <a href="#-as-is-and-as-available-disclaimer">
          ...
          <h2 id="interpetation-and-definitions">
            Interpetation and Definitions
          </h2>
          <h3 id="interpretation">Interpretation</h3>
          <p>
            The following words of which the initial letter is capitalized have
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to TV Tracker.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <a href="https://www.privacypolicies.com/">
          ...
          <h3 id="for-european-union-eu-users">
          ...
          <h3 id="united-states-legal-compliance">
          ...
          <p>
            ...
            English text shall prevail in the case of a dispute. Changes to
          ...
          <p className="link">
            ...
            contact us via <Link to="/meet-the-team">our contact page</Link>.
          </p>
          <br />
          <a className="link" href="#header-title">
            Back to top
          </a>
          <br />
        </div>
